...
async function loadFormSettings() {
    ...
    if (settings.metadataFirstLineOnly !== undefined)
        $('metadataFirstLineOnly').checked = settings.metadataFirstLineOnly;
    ...
    if (settings.metadataFont) {
        $('metadataFont').value = settings.metadataFont;
        $('metadataFont').style.fontFamily = settings.metadataFont;
    }
    ...
    if (settings.metadataOpacity) {
        $('metadataOpacity').value = settings.metadataOpacity;
        $('metadataOpacityValue').textContent = settings.metadataOpacity + '%';
    }
