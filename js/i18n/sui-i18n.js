    ...
    const TRANSLATIONS = {
        ja: {
            ...
            config: {
                ...
                workflowI2IAngle: 'ワークフロー (I2I_Angle)',
                workflowUpscale: 'ワークフロー (Upscale)',
                upscalerModel: 'アップスケーラーモデル',
                upscalerModelFromWorkflow: 'ワークフロー設定に従う',
                workflowRembg: 'ワークフロー (REMBG)',
                notSelected: '未選択',
                noWorkflows: 'ワークフローがありません',
                openWorkflowManager: 'ComfyUI Workflowsを開く',
                generateCount: '生成枚数',
            ...
            toast: {
                ...
                // Workflow selection
                workflowSwitched: 'ワークフローを切り替えました',
                workflowSwitchFailed: 'ワークフローの切り替えに失敗しました',
                // Language change
            ...
            workflowEditor: {
                ...
                noticeTitle: '注意',
                noticeItem1:
                    '・タイプごとに使うWorkflowを指定できます。自分で好きなWorkflowを使いたい場合はAPI用をComfyUIからExportして追加してください。',
                noticeItem2:
                    '・ComfyUIがオンラインになると自動的にモデルリスト等が更新されます。一度でも更新するとComfyUIのモデルリストはブラウザに格納されます。',
                noticeItem3: '・seed, noise_seedに0を指定するとランダムになります。',
                noticeItem4:
                    '・テキストに以下を指定すると置き換えます。%prompt%→ポジティブプロンプト、%negative%→ネガティブプロンプト',
            },
            settings: {
                title: '設定',
                theme: 'テーマ',
            ...
            errorGuide: {
                ...
                comfyuiOfflineMessage:
                    'ComfyUIサーバーとの接続が確立できませんでした。生成を行うにはComfyUIが起動している必要があります。',
                ...
                comfyuiOfflineStep3:
                    '詳細設定のComfyUI URLが正しいか確認してください（デフォルト: http://127.0.0.1:8188）',
                comfyuiOfflineStep4: 'ファイアウォールがComfyUIの通信をブロックしていないか確認してください',
                // Workflow Not Found
                workflowNotFoundTitle: 'ワークフローが設定されていません',
                workflowNotFoundMessage:
                    '{type}用の有効なワークフローが見つかりません。生成を行うにはワークフローの設定が必要です。',
                workflowNotFoundCause: 'ワークフローが登録されていない、または有効化されていません。',
                workflowNotFoundStep1:
                    'サイドバーの「ComfyUI Workflows」ボタンをクリックしてWorkflowエディタを開きます',
                ...
                workflowNodeMissingMessage:
                    'ワークフロー内で使用されているカスタムノードがComfyUIにインストールされていません。',
                ...
                generationErrorStep2:
                    'ComfyUI Workflows設定画面でテスト生成を行うか、WorkflowをダウンロードしてComfyUI本体で確認してください',
        ...
        en: {
            ...
            config: {
                ...
                workflowI2IAngle: 'Workflow (I2I_Angle)',
                workflowUpscale: 'Workflow (Upscale)',
                upscalerModel: 'Upscaler Model',
                upscalerModelFromWorkflow: 'Use workflow setting',
                workflowRembg: 'Workflow (REMBG)',
                notSelected: 'Not Selected',
                noWorkflows: 'No workflows available',
                openWorkflowManager: 'Open ComfyUI Workflows',
                ...
                rembgGenerate: 'Remove Background',
            ...
            toast: {
                ...
                workflowSwitchFailed: 'Failed to switch workflow',
                // Language change
            ...
            workflowEditor: {
                ...
                noticeTitle: 'Notice',
                noticeItem1:
                    '- You can specify workflows per type. If you want to use your own workflow, export it for API from ComfyUI and add it.',
                noticeItem2:
                    '- Model lists are automatically updated when ComfyUI comes online. Once updated, ComfyUI model lists are stored in the browser.',
            ...
            errorGuide: {
                ...
                comfyuiOfflineMessage:
                    'Could not establish connection to ComfyUI server. ComfyUI must be running to generate images.',
                ...
                workflowNotFoundMessage:
                    'No valid workflow found for {type}. A workflow must be configured to generate images.',
                ...
                generationErrorCause:
                    'There may be an issue with the workflow configuration, or an error occurred in ComfyUI.',
                generationErrorStep1: 'Check ComfyUI console for error messages',
                generationErrorStep2:
                    'Test generation in ComfyUI Workflows settings, or download the workflow and test in ComfyUI',
        ...
        zh: {
            ...
            config: {
                ...
                workflowT2I: '工作流 (T2I)',
                workflowI2I: '工作流 (I2I)',
                workflowI2IAngle: '工作流 (I2I_Angle)',
                workflowUpscale: '工作流 (Upscale)',
                upscalerModel: '放大模型',
                upscalerModelFromWorkflow: '使用工作流设置',
                workflowRembg: '工作流 (REMBG)',
                notSelected: '未选择',
                noWorkflows: '没有可用的工作流',
                openWorkflowManager: '打开 ComfyUI Workflows',
                generateCount: '生成数量',
            ...
            toast: {
                ...
                // Workflow selection
                workflowSwitched: '已切换工作流',
                workflowSwitchFailed: '切换工作流失败',
                // Language change
