...
function checkActiveImage() {
    ...
    const text = I18nManager.t('toast.nothingImage');
...
function checkPanelImage() {
    ...
    const text = I18nManager.t('toast.nothingPanel');
    createToast(text, '', 2000);
    return false;
}

function checkRoughTarget() {
    const text = I18nManager.t('toast.roughTarget');
    const roughTargetMessage = I18nManager.t('toast.roughTargetMessage');
