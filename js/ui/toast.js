...
let text=I18nManager.t("toast.nothingImage");
...
let text=I18nManager.t("toast.nothingPanel");
createToast(text,"",2000);
return false;
}

function checkRoughTarget() {
let text=I18nManager.t("toast.roughTarget");
let roughTargetMessage=I18nManager.t("toast.roughTargetMessage");
